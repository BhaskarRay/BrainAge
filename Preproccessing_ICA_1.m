...
%% loading imaging --------
imgpath='C:/Users/bray14/pncDataNew/';% change to your path
imgfiles = dir([imgpath,'sm6mwc1*nii']);% changed to your files
...
%sMRItransdata1 = reshape(sMRIdata,sub,x*y*z);
...
removind = find(r<0.9);
sMRIdata1(:,removind)=[];
%sMRItransdata1(removind,:)=[];
sMRItransdataTranspose = sMRIdata1.';
...
%save('Preproccessing_ICA_1.m','sMRIdata_n','-v7.3');
...
[b1, mdlVal, aicVal] = ica_fuse_estimate_dimension(sMRIdata_n, [6 6 6]);
...
num_ica_runs = 10;
algorithm = 1;
[A, W, icasig, iq, metric_Q] = myIcasso(data, numOfIC, num_ica_runs, algorithm);
